...
@section('title', 'Admin | product Show')
    ...
    <div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
        <div class="col-md-6">
            ...
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item text-dark"><a href="#">Show</a></li>
            </ol>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-12 p-0">
            <div class="card">
                <div class="card-header justify-content-between py-3">
                    <h4 class="card-title float-left pt-2">Product Show</h4>
                </div>
                <!-- /.card-header -->
                    ...
                    <form action="{{ route('admin.products.update', $product->id) }}" class="form-horizontal"
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                placeholder="Name (English)" value="{{ $product->name }}" disabled>
                                            @error('name')
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name_bangla"
                                                ...
                                                value="{{ old('name_bangla', $product->name_bangla) }}"disabled>
                                            @error('name_bangla')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sub_title"
                                                ...
                                                value="{{ old('sub_title', $product->sub_title) }}"disabled>
                                            @error('sub_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="published_price"
                                                ...
                                                value="{{ old('published_price', $product->published_price) }}"disabled>
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="purchase_price"
                                                ...
                                                value="{{ old('purchase_price', $product->purchase_price) }}"disabled>
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="sell_price"
                                                ...
                                                value="{{ old('sell_price', $product->sell_price) }}"disabled>
                                            @error('sell_price')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="current_stock"
                                                ...
                                                value="{{ old('current_stock', $product->current_stock) }}"disabled>
                                            @error('current_stock')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="safety_level"
                                                ...
                                                id="Reference No" placeholder="Reference No.."
                                                value="{{ old('safety_level', $product->safety_level) }}"disabled>
                                            @error('safety_level')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="reorder_level"
                                                ...
                                                placeholder="reorder_level  .."disabled>
                                            @error('reorder_level')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="input-group mr-2">
                                                <div class="input-group">
                                                    <select name="category_id" id="mySelect" data-live-search="true"
                                                        class="selectpicker @error('category_id') is-invalid @enderror"disabled>
                        ...
                        <div class="my-4 text-right">
                            <a type="button" class="btn btn-danger"
                                href="{{ route('admin.products.index') }}">Close</a>
                        </div>
                    </form>
                </div>
                <!-- /.card-body -->
